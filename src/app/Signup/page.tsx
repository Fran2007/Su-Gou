...
// 
  ...
  return (
    ...
    <div className='bg-contain bg-right transform -translate-y-[-96]'>
    ...
    <div className="flex ml-auto z-0 mr-24 -translate-y-11">
        <Form {...form} >
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button onClick={() => signIn('Google')} style={{width: '25%', height:'12%', display: 'flex', justifyContent: 'center',  alignItems: 'center'}} className='border-solid border-2 border-slate-200 rounded-lg'>
             <Image src={google} alt='Image' width={20} height={50} className='mx-auto'/>
              </button>
          </form>
        </Form>
      </div>
